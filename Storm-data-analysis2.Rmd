...
#add column "EVTYPE2"
#EVTYPEs are classified to 48(+"OTHERS") types of events and stored in new column "EVTYPE2"
...
This question can be discussed from the point of "INJURY" and "FATALITY".
...
grid.arrange(fgraph,igraph)
```

## Question 2
**Across the United States, which types of events have the greatest economic consequences?**

This question can be discussed from the point of "PROPDMG" and "CROPDMG".
